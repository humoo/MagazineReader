...
public class RxFormatTool {
    ...
    public static int[] stringToInts(String s) {
        ...
        if (RxFormatTool.isNullString(s)) {
    ...
    public static String byte2FitSize(long byteNum) {
        if (byteNum < 0) {
            ...
            return String.format(Locale.getDefault(), "%.2fKB", (double) byteNum / RxConstTool.KB);
        } else if (byteNum < RxConstTool.GB) {
            return String.format(Locale.getDefault(), "%.2fMB", (double) byteNum / RxConstTool.MB);
        } else {
            return String.format(Locale.getDefault(), "%.2fGB", (double) byteNum / RxConstTool.GB);
        }
    }
     ...
     * @return
     */
    public static String getRoundUp(float value, int digit) {
        BigDecimal result = new BigDecimal(value);
        return result.setScale(digit, BigDecimal.ROUND_HALF_UP).toString();
    }
