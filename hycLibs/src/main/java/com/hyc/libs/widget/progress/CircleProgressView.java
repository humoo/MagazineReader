...
/**
 * @author zhxumao
 *         Created on 2018/1/16 0016 17:52.
 */
...
public class CircleProgressView extends View {
    ...
    public CircleProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        location = array.getInt(R.styleable.CircleProgressView_circle_location, 1);
        mPaintWidth = array.getDimension(R.styleable.CircleProgressView_circle_progress_paint_width, dip2px(context, 4));//默认4dp
        mPaintColor = array.getColor(R.styleable.CircleProgressView_circle_progress_paint_color, mPaintColor);
        mTextSize = array.getDimension(R.styleable.CircleProgressView_circle_progress_text_size, dip2px(context, 18));//默认18sp
        mTextColor = array.getColor(R.styleable.CircleProgressView_circle_progress_text_color, mTextColor);
        array.recycle();
        ...
        mPaintCurrent.setStrokeWidth(50);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.e("logd","width = "+width);
        Log.e("logd","height = "+height);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        RectF rectF = new RectF(50 / 2, 50 / 2, getWidth() - 50 / 2, getHeight() - 50 / 2);
