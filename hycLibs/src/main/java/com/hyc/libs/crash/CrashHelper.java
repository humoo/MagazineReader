...
public final class CrashHelper {
    ...
    //General constants
    private final static String TAG = Configure.DEBUG_TAG + "-" + CrashHelper.class.getSimpleName();
        ...
        public void uncaughtException(Thread thread, final Throwable throwable) {
            ...
            if (crashActivityClass == null) {
                ...
                new Thread() {
                    ...
                    public void run() {
                        try {
                            File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath(), "hyc-crash.log");
